...
import { TrendingUp, TrendingDown, DollarSign, ShoppingCart, EyeOff, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-[#E2E8F0] dark:border-slate-800 shadow-sm">
